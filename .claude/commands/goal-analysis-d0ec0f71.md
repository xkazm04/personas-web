# How It Works Page Refresh � Accessible Copy + Aligned with Desktop App

## Goal
Rewrite /how page for non-technical users. Simplify AgentsTimeline, AgentsChat, PlatformLayers, EventBusShowcase sections using the accessible brand voice. Align messaging with desktop app capabilities. Keep animations, refresh copy.
