...
## Target Context
- Context ID: ctx_1776165057162_hl9ciwt
- Context Name: Auth & State Management
...
**Context Description**:
Authentication provider, Zustand stores (persona, system, event, execution, review), React contexts, custom hooks for polling, streaming, and UI state
...
- src/contexts/QualityContext.tsx
- src/contexts/SectionObserverContext.tsx
...

{
  ...
  "project_id": "39de516e-059b-4b1a-86ad-f28e8abddaf7",
  "context_id": "ctx_1776165057162_hl9ciwt",
  "scan_type": "ui_perfectionist",
  "category": "<category>",
  "title": "<title>",
