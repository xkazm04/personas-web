# Guide Quality Upgrade � Sidebar Navigation, Illustrations, Markdown Content

## Goal
Restructure guide with sidebar navigation ordered by user journey. Generate custom illustrations via Leonardo (dark/light variants). Build custom markdown renderer (no npm packages). Write full markdown content for all 102 topics. Redesign cards with large illustrations.
