# Landing Page Capability Refresh � Align with Desktop App

## Goal
Update Hero, add differentiator callouts, and refresh landing page sections to accurately reflect the Personas desktop apps 18+ features (multi-agent orchestration, security vault, multi-provider AI, self-healing, genome evolution, 40+ connectors). Current marketing undersells the product depth.
