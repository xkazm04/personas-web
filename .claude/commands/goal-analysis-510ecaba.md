# SEO + Sitemap + Structured Data Audit

## Goal
Ensure all 70+ routes are in sitemap.xml. Add JSON-LD for guide, templates, feature pages. Verify meta descriptions on every page. Fix any SEO gaps.
