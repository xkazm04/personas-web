...
Analyze the **personas-web** codebase at **C:\Users\kazda\kiro\personas-web** and create/update intelligent, structure-based contexts in the SQLite database.

## Project Information

- **Project ID**: 39de516e-059b-4b1a-86ad-f28e8abddaf7
- **Project Name**: personas-web
- **Project Path**: C:\Users\kazda\kiro\personas-web
- **Project Type**: nextjs
- **Scan Timestamp**: 2026-03-01T23-09-41
...
- `PROJECT_PATH` → C:\Users\kazda\kiro\personas-web
...
```bash
curl -X GET "http://localhost:3000/api/contexts?projectId=39de516e-059b-4b1a-86ad-f28e8abddaf7"
```
...
find "C:\Users\kazda\kiro\personas-web/src/app" -maxdepth 1 -type d -name "*-page" 2>/dev/null
find "C:\Users\kazda\kiro\personas-web/src/app/features" -maxdepth 1 -type d -name "sub_*" 2>/dev/null
```

### 3. Read High-Level Architecture (Optional)

```bash
cat "C:\Users\kazda\kiro\personas-web/context/high.md" 2>/dev/null || echo "No high-level architecture file found"
```
...
mkdir -p "C:\Users\kazda\kiro\personas-web/docs/contexts"

# Generate the report
cat > "C:\Users\kazda\kiro\personas-web/docs/contexts/scan-report-2026-03-01T23-09-41.md" << 'EOF'
# Context Scan Report

**Date**: 2026-03-01T23-09-41
...
C:\Users\kazda\kiro\personas-web/docs/contexts/scan-report-2026-03-01T23-09-41.md
