...
## Target Context
- Context ID: ctx_1776165025708_aso1xb5
- Context Name: Blog & Community Hub
...
**Context Description**:
Blog with category filtering, featured posts, article rendering with OG images, and community hub with channel cards, contribute section, and join CTA

**Files in this Context** (17 files):
- src/app/blog/page.tsx
- src/app/blog/layout.tsx
- src/app/blog/BlogPostCard.tsx
- src/app/blog/CategoryFilter.tsx
- src/app/blog/FeaturedPost.tsx
- src/app/blog/category-meta.ts
- src/app/blog/[slug]/page.tsx
- src/app/blog/[slug]/BlogArticle.tsx
- src/app/blog/[slug]/opengraph-image.tsx
- src/app/community/page.tsx
- src/app/community/layout.tsx
- src/app/community/ChannelCard.tsx
- src/app/community/ContributeCard.tsx
- src/app/community/JoinCta.tsx
- src/app/community/data.ts
- src/data/blog.ts
...
### Pending Ideas (1)
1. **Reading progress bar and sticky TOC for articles** (ui)
   - Add a thin gradient progress bar (brand-cyan to brand-purple) fixed to the top of BlogArticle pages that fills as the user scrolls. For articles with ...
...

{
  ...
  "project_id": "39de516e-059b-4b1a-86ad-f28e8abddaf7",
  "context_id": "ctx_1776165025708_aso1xb5",
  "scan_type": "brand_artist",
  "category": "<category>",
  "title": "<title>",
