...
## Goal
Build /tour with step-by-step visual walkthrough: create agent, configure tools, set triggers, watch execution, monitor results. Screenshot-driven tour with animated transitions.
