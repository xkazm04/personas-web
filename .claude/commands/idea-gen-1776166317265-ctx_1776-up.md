...
## Target Context
- Context ID: ctx_1776165129566_e0awyqc
- Context Name: System & Plugin Experiments
...
**Context Description**:
Plugin marketplace prototype with artist, dev tools, research, and document signing modules, trigger system wheel, security vault pillars, lab arena, and multi-provider AI

**Files in this Context** (34 files):
- src/components/todo/Plugins.tsx
- src/components/todo/plugins/index.tsx
- src/components/todo/plugins/data.ts
- src/components/todo/plugins/types.ts
- src/components/todo/plugins/ArtistGrid.tsx
- src/components/todo/plugins/DevToolsLifecycle.tsx
- src/components/todo/plugins/DevToolsRunner.tsx
- src/components/todo/plugins/DocSigningList.tsx
- src/components/todo/plugins/ObsidianBrowser.tsx
- src/components/todo/plugins/ObsidianCloudSync.tsx
- src/components/todo/plugins/OcrBatch.tsx
- src/components/todo/plugins/OcrScanner.tsx
- src/components/todo/plugins/ResearchLifecycle.tsx
- src/components/todo/plugins/ResearchSources.tsx
- src/components/todo/plugins/components/PluginCard.tsx
- src/components/todo/plugins/components/PluginTabs.tsx
- src/components/todo/TriggerSystem.tsx
- src/components/todo/trigger-system/index.tsx
- src/components/todo/trigger-system/data.ts
- src/components/todo/trigger-system/types.ts
- src/components/todo/trigger-system/components/TriggerDetail.tsx
- src/components/todo/trigger-system/components/TriggerWheel.tsx
- src/components/todo/SecurityVault.tsx
- src/components/todo/SecurityVaultPillars.tsx
- src/components/todo/Lab.tsx
- src/components/todo/lab/index.tsx
- src/components/todo/lab/data.ts
- src/components/todo/lab/types.ts
- src/components/todo/lab/components/ArenaTab.tsx
- src/components/todo/lab/components/ChatTab.tsx
- src/components/todo/lab/components/EvalTab.tsx
- src/components/todo/lab/components/EvolutionTab.tsx
- src/components/todo/lab/components/TabSwitcher.tsx
- src/components/todo/MultiProviderAI.tsx
...

{
  ...
  "project_id": "39de516e-059b-4b1a-86ad-f28e8abddaf7",
  "context_id": "ctx_1776165129566_e0awyqc",
  "scan_type": "ui_perfectionist",
  "category": "<category>",
  "title": "<title>",
