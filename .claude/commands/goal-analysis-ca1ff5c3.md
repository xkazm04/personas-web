# Guide-to-Desktop Cross-Reference System

## Goal
Scan desktop app client code to map modules/features. Add non-aggressive icon-based cross-references in guide topics linking to relevant desktop app modules. Update guide content to reflect actual app state. Use platform-agnostic link component (no raw <a href>) so desktop app can handle link opening differently.
