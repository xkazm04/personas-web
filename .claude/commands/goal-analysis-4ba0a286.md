# Use Case Pages by Workflow Type

## Goal
Build /use-cases hub with 5 dedicated pages: Development, Content, Research, DevOps, Communication. Each with agent configs, trigger types, connector combos, and workflow examples.
