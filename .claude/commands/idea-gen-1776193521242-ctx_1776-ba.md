...
## Target Context
- Context ID: ctx_1776165039752_0v8p86u
- Context Name: Use Cases & Download
...
**Context Description**:
Use case pages with dynamic slug routing and detail views, download page with OS detection, install guide, FAQ, and platform cards

**Files in this Context** (24 files):
- src/app/use-cases/page.tsx
- src/app/use-cases/layout.tsx
- src/app/use-cases/[slug]/page.tsx
- src/app/use-cases/[slug]/UseCaseDetail.tsx
- src/components/sections/UseCases.tsx
- src/components/sections/use-cases/index.tsx
- src/components/sections/use-cases/data.ts
- src/components/sections/use-cases/types.ts
- src/components/sections/use-cases/useConnectorPath.ts
- src/components/sections/use-cases/useToolSelection.ts
- src/components/sections/use-cases/components/AgentArmyGrid.tsx
- src/components/sections/use-cases/components/ConnectorIcon.tsx
- src/components/sections/use-cases/components/ToolButton.tsx
- src/components/sections/use-cases/components/ToolDetailCard.tsx
- src/components/sections/use-cases/components/ToolGrid.tsx
- src/app/download/page.tsx
- src/app/download/layout.tsx
- src/app/download/opengraph-image.tsx
- src/app/download/InstallGuide.tsx
- src/app/download/DownloadFaq.tsx
- src/app/download/PlatformCard.tsx
...
Found 4 active idea(s) (10 total, excluding rejected/implemented for brevity):

### Pending Ideas (3)
1. **OS-aware download hero with skeleton loading state** (functionality)
   - The download page detects the user OS on mount but shows no loading state while JavaScript hydrates � the platform selector renders with a default or ...
2. **Context-aware use case to download deep linking** (ui)
   - When a user clicks "Download Free" or "Get started" from a UseCaseDetail page, carry the use case context through to the download and post-install exp...
3. **Add platform waitlist signup for Coming Soon OSes** (functionality)
   - Replace the dead-end "Coming soon" label on macOS and Linux PlatformCards with an email waitlist signup inline form. When a user on an unavailable pla...

### Accepted Ideas (1)
1. **Surface Claude CLI dependency before download click** (user_benefit)
   - Move the Claude CLI subscription requirement from the buried InstallGuide requirements section to a prominent callout directly on the PlatformCard and...
...

{
  ...
  "project_id": "39de516e-059b-4b1a-86ad-f28e8abddaf7",
  "context_id": "ctx_1776165039752_0v8p86u",
  "scan_type": "brand_artist",
  "category": "<category>",
  "title": "<title>",
