# i18n Content Expansion � Translate Key Content to 13 Languages

## Goal
Translate guide category descriptions, template summaries, and feature page headlines/descriptions into the 13 non-English languages. Currently only UI strings are translated.
