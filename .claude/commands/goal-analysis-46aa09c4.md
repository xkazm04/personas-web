# E2E Tests � Templates, Feature Pages, Connections

## Goal
Add Playwright tests covering templates gallery + detail pages, feature deep-dive pages, and connections catalog. Validate the full session output.
