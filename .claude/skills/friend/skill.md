---
name: friend
description: "Endless companion loop scoped to one area of the **personas-web** codebase. Each cycle: scan → propose **5 development directions** → user picks a number → execute with repo conventions → report → pro"
