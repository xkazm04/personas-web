...
export const id: Translations = {
  ...
  tour: {
    ...
    step1: 'Ini Personas — pusat kendali lokal Anda. Semua di sini berjalan di komputer Anda sendiri, di bawah kendali Anda.',
    step2: 'Jelaskan tujuan dengan kata-kata sederhana, dan saksikan agen mengurainya, merencanakan langkah-langkahnya, dan menjalankannya — secara langsung.',
    step3: 'Salah satu dari delapan jenis pemicu dapat membangunkan agen, dan orkestrator membagi pekerjaan di antara mereka, memperbaiki dirinya sendiri sambil berjalan.',
    features1: 'Setiap agen bermula sebagai niat: satu kalimat mengisi matriks persona delapan dimensi — tugas, memori, pemicu, dan lainnya.',
    features2: 'Ia belajar sambil bekerja — pelajaran dan pola mengendap di lapisan memori, sehingga agen makin tajam pada setiap tugas.',
    features3: 'Ketika sebuah langkah gagal, sirkuit tidak berhenti: ia mendiagnosis kegagalan, memperbaiki jalurnya, dan mencoba lagi dengan sendirinya.',
    features4: 'Dan Anda melihat semuanya — setiap eksekusi, pesan, dan peristiwa mengalir langsung melalui satu dek observabilitas.',
