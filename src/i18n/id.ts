...
export const id: Translations = {
  ...
  eventsPage: {
    ...
    connectionStatus: {
      ...
      reconnecting: 'Menghubungkan ulang ke aliran eventâ€¦',
  ...
  tour: {
    ...
    step3: 'Sebuah agen hanya berguna sebatas momen saat ia terbangun. Personas dapat dipicu dengan delapan cara — sesuai jadwal, oleh sebuah peristiwa, dengan polling sebuah sumber, atau dari webhook masuk. Orkestrator mengarahkan setiap sinyal ke agen yang tepat dan menjaga semuanya tetap bergerak, memperbaiki dirinya sendiri jika sebuah langkah gagal.',
    ...
    dashboard1: 'Selamat datang di pusat kendali. Lencana di bagian atas adalah vital armada Anda dalam sekilas — tingkat keberhasilan, eksekusi yang sedang berjalan, agen aktif, peringatan terbuka, dan tinjauan tertunda. Lima angka yang memberitahu Anda dalam dua detik apakah semuanya berjalan lancar atau ada yang perlu perhatian.',
    dashboard2: 'Tepat di bawahnya, optimizer menampilkan satu peningkatan berdampak tinggi pada satu waktu. Saat ini ia menunjuk perubahan rute yang akan menekan biaya pada sebagian eksekusi tanpa mengorbankan kualitas. Terapkan dari sini, atau abaikan dan kesempatan berikutnya akan menggantikannya besok.',
    dashboard3: 'Dua panel intelijen berada di bawahnya. Di kiri, skor detak jantung tiap agen beserta masalah yang dilihat minggu ini. Di kanan, ingatan baru yang dipelajari agen Anda dan ingin dipromosikan — throttle yang berhasil, jadwal yang lebih pas. Terima yang berguna, arsipkan sisanya.',
    dashboard4: 'Sekarang gambaran langsung. Umpan aktivitas di kiri menampilkan setiap eksekusi saat tiba, lengkap dengan persona, durasi, dan biaya. Di kanan, empat belas hari lalu lintas terhadap kesalahan — lonjakan, penurunan, dan pergeseran muncul jauh sebelum menjadi insiden.',
    dashboard5: 'Perbesar satu tingkat lagi. Heatmap menampilkan eksekusi per agen, hari demi hari — sel lebih pekat berarti agen lebih sibuk. Sekilas Anda tahu agen mana yang menanggung beban berat, mana yang sedang istirahat, dan ke mana beban bergeser sepanjang minggu.',
    dashboard6: 'Dan akhirnya baris bawah. Tabel peringkat menyusun tiga agen teratas Anda beserta tren yang menaikkan atau menurunkannya. Rutinitas mendatang menampilkan eksekusi terjadwal berikutnya. Dan brankas kredensial melacak setiap rotasi rahasia agar Anda selalu tahu kunci mana yang segar. Inilah pusat kendali — eksekusi, kesehatan, dan operasi dalam satu halaman.',
