...
export const id: Translations = {
  ...
  hero: {
    ...
    subtitle: 'Satu persona, banyak kemampuan. Bangun asisten dengan identitas yang stabil dan susun pekerjaan yang dilakukannya — tambah, aktifkan, atau pensiunkan kemampuan tanpa harus mulai dari awal.',
    cta: 'Mulai Sekarang',
  ...
  useCasesSection: {
    ...
    patterns: 'kemampuan',
    description: 'Setiap persona memiliki identitas yang stabil dan sekumpulan kemampuan yang dapat disusun — klik integrasi mana pun untuk menjelajahi pekerjaan yang bisa dilakukan sebuah persona.',
  ...
  reviewsPage: {
    focus: {
      ...
      skip: 'Lewati',
      empty: 'Semua selesai — tidak ada ulasan tertunda',
      approve: 'Setujui',
      reject: 'Tolak',
      shortcuts: 'A setujui · R tolak · S lewati · Esc keluar',
    },
  },
  leaderboardPage: {
  ...
  templatesPage: {
    ...
    gridDescription: 'Templat adalah Personas yang sudah dikonfigurasi dan bisa Anda adopsi dengan satu klik. Setiap templat sudah dilengkapi prompt, alat, dan pemicu untuk tugas tertentu — tanpa perlu pengaturan.',
  ...
  heroTransition: {
    ...
    privacy: 'Private',
    scale: 'Scalable',
    value: 'Satu persona, banyak kemampuan — identitas yang stabil dengan sekumpulan pekerjaan yang dapat disusun, berjalan di mana data Anda berada dan tetap di bawah kendali Anda.',
