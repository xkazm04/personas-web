...
export const de: Translations = {
  ...
  tour: {
    ...
    step1: 'Das ist Personas — Ihr lokales Kommandozentrum. Alles hier läuft auf Ihrem eigenen Rechner, unter Ihrer Kontrolle.',
    step2: 'Beschreiben Sie ein Ziel in einfachen Worten und sehen Sie zu, wie der Agent es analysiert, seine Schritte plant und ausführt — live.',
    step3: 'Jeder von acht Triggertypen kann einen Agenten wecken, und der Orchestrator verteilt die Arbeit zwischen ihnen, während er sich selbst heilt.',
    features1: 'Jeder Agent beginnt als Absicht: ein Satz füllt eine achtdimensionale Persona-Matrix — Aufgaben, Speicher, Trigger und mehr.',
    features2: 'Er lernt im Arbeiten — Lektionen und Muster setzen sich in Speicherschichten ab, sodass der Agent mit jeder Aufgabe schärfer wird.',
    features3: 'Wenn ein Schritt fehlschlägt, hält die Schaltung nicht an: Sie diagnostiziert den Fehler, repariert den Pfad und versucht es von selbst erneut.',
    features4: 'Und Sie sehen alles — jede Ausführung, Nachricht und jedes Ereignis strömt live durch ein einziges Observability-Deck.',
