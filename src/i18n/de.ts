...
export const de: Translations = {
  ...
  tour: {
    ...
    step3: 'Ein Agent ist nur so nützlich wie die Momente, für die er aufwacht. Personas lassen sich auf acht Arten auslösen — per Zeitplan, durch ein Ereignis, durch Abfragen einer Quelle oder über einen eingehenden Webhook. Der Orchestrator leitet jedes Signal an den richtigen Agenten und hält alles in Bewegung — und heilt sich selbst, falls ein Schritt einmal fehlschlägt.',
    ...
    dashboard1: 'Willkommen in der Kommandozentrale. Die Badges oben sind die Vitalwerte Ihrer Flotte auf einen Blick — Erfolgsrate, laufende Aufgaben, aktive Agenten, offene Warnungen und ausstehende Prüfungen. Fünf Zahlen, die Ihnen in zwei Sekunden sagen, ob alles im Plan ist oder Ihre Aufmerksamkeit gefordert ist.',
    dashboard2: 'Direkt darunter zeigt der Optimizer eine wirkungsvolle Verbesserung nach der anderen. Gerade weist er auf eine Routing-Änderung hin, die Kosten bei einem Teil der Läufe senkt, ohne die Qualität zu beeinträchtigen. Wenden Sie sie hier an oder verwerfen Sie sie — morgen folgt die nächste Empfehlung.',
    dashboard3: 'Zwei Intelligence-Panels stehen darunter. Links der Heartbeat-Wert jedes Agenten samt den Issues dieser Woche. Rechts neue Erinnerungen, die Ihre Agenten gelernt haben und übernehmen möchten — eine Drosselung, die funktioniert hat, ein Zeitplan, der besser passt. Akzeptieren Sie das Nützliche, archivieren Sie den Rest.',
    dashboard4: 'Nun das Live-Bild. Der Activity-Feed links zeigt jede Ausführung beim Eintreffen, mit Persona, Dauer und Kosten. Rechts vierzehn Tage Traffic gegen Fehler — Spikes, Senken und Verschiebungen treten lange vor jedem Vorfall hervor.',
    dashboard5: 'Zoomen Sie eine Ebene heraus. Die Heatmap zeigt Läufe pro Agent, Tag für Tag — dichtere Zellen bedeuten geschäftigeren Agent. Sie sehen sofort, welche Agenten die Hauptarbeit leisten, welche ruhen und wohin sich die Last über die Woche verschiebt.',
    dashboard6: 'Und schließlich die letzte Reihe. Das Leaderboard listet Ihre drei besten Agenten samt Trend, der sie hebt oder senkt. Anstehende Routinen zeigt die nächsten geplanten Läufe. Und der Anmeldedaten-Tresor verfolgt jede Geheimnis-Rotation, damit Sie immer wissen, welche Schlüssel frisch sind. Das ist die Kommandozentrale — Läufe, Gesundheit und Betrieb auf einer Seite.',
