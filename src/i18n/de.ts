...
export const de: Translations = {
  ...
  hero: {
    ...
    mode1: 'Kombinierbare Fähigkeiten',
  ...
  useCasesSection: {
    ...
    description: 'Jede Persona trägt eine stabile Identität und kombinierbare Fähigkeiten — klicken Sie auf eine Integration, um die Aufgaben zu erkunden, die eine Persona erledigen kann.',
  ...
  knowledgePage: {
    ...
    title: "Wissensgraph",
    subtitle: "Aus Agentenausführungen gelernte Muster",
    denseTable: "Dichte Tabelle",
    graph: "Graph",
    memories: "Erinnerungen",
    type: "Typ",
    patternKey: "Musterschlüssel",
    agent: "Agent",
    success: "Erfolg",
    successLower: "Erfolg",
    failures: "Fehler",
  ...
  reviewsPage: {
    ...
    parseError: {
      ...
      detail: 'Ungültige Nutzlast — bis zur Prüfung als kritisch eingestuft',
    },
  },
  leaderboardPage: {
    compare: 'Vergleichen',
  ...
  observabilityPage: {
    ...
    budgetThresholdExceeded: 'Budgetschwelle überschritten für',
    totalCost: 'Gesamtkosten',
    executions: 'Ausführungen',
    successRate: 'Erfolgsrate',
    activePersonas: 'Aktive Personas',
    costOverTime: 'Kosten im Zeitverlauf',
    previousPeriod: 'ggü. vorherigem Zeitraum',
    executionHealth: 'Ausführungszustand',
    ...
    runningAnalysis: 'Zustandsanalyse über alle überwachten Dienste läuft...',
    allSystemsHealthy: 'Alle Systeme fehlerfrei',
    noIssuesDetected: 'Keine Probleme in überwachten Diensten erkannt',
    noSeverityIssues: 'Keine Probleme mit Schweregrad {severity}',
    exampleDataNotice: 'Es werden Beispieldaten angezeigt. Echte Analysen erscheinen, sobald Agenten Ausführungen starten.',
  ...
  eventsPage: {
    ...
    retry: 'Wiederholen',
    selectForBulkRetry: 'Für Sammelwiederholung auswählen',
    ...
    failedEventSelected: 'fehlgeschlagenes Ereignis ausgewählt',
    failedEventsSelected: 'fehlgeschlagene Ereignisse ausgewählt',
    selectAllFailed: 'Alle fehlgeschlagenen auswählen',
    ...
    connectionStatus: {
      ...
      polling: 'Abfrage von Updates (verzögert)',
    },
  },
  settingsPage: {
    title: 'Einstellungen',
  ...
  templatesPage: {
    ...
    subtitle: 'Durchstöbern Sie {count} vorgefertigte Agenten-Vorlagen, gruppiert nach Art der Arbeit. Wählen Sie eine Kategorie, um die Vorlagen darin zu sehen.',
    gridHeading: 'Vorlagen nach Kategorie durchsuchen',
    gridDescription: 'Vorlagen sind vorkonfigurierte Personas, die Sie mit einem Klick übernehmen können. Jede Vorlage bringt bereits Prompt, Tools und Trigger für eine bestimmte Aufgabe mit — ganz ohne Einrichtung.',
    ...
    filterByComplexity: 'Nach Komplexität filtern',
    ...
    openInPersonas: 'In Personas öffnen',
    moreTemplates: 'Weitere {category}-Vorlagen',
    appNotFoundTitle: 'Personas-App nicht gefunden',
    appNotFoundDescription: 'Personas scheint auf Ihrem Gerät noch nicht installiert zu sein. Laden Sie es herunter, um Vorlagen direkt zu importieren, oder kopieren Sie die Konfiguration für die manuelle Einrichtung.',
  ...
  blogPage: {
    ...
    description: 'Produktankündigungen, technische Deep Dives, Tutorials und reale Anwendungsfälle vom Personas-Team.',
    searchPlaceholder: 'Beiträge suchen...',
    searchAriaLabel: 'Blogbeiträge suchen',
    clearSearch: 'Suche löschen',
    showing: 'Zeige',
    of: 'von',
    posts: 'Beiträgen',
    noMatches: 'Keine Beiträge passen zu Ihrer Suche',
    ...
    postNotFoundDescription: 'Der gesuchte Artikel wurde nicht gefunden. Er wurde möglicherweise umbenannt oder verschoben.',
    browseAllPosts: 'Alle Beiträge ansehen',
    backToHome: 'Zur Startseite',
  },
  accessibility: {
    changeLanguage: 'Sprache ändern',
    selectLanguage: 'Sprache auswählen',
    selectTheme: 'Thema auswählen: {name}',
  },
  pageNav: {
  ...
  heroTransition: {
    ...
    privacy: 'Private',
    scale: 'Scalable',
    value: 'Eine Persona, viele Fähigkeiten — eine stabile Identität mit kombinierbaren Aufgaben, die dort läuft, wo Ihre Daten liegen, und die unter Ihrer Kontrolle bleibt.',
