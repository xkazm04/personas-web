...
export const fr: Translations = {
  ...
  knowledgePage: {
    ...
    subtitle: "Modèles appris à partir des exécutions d'agents",
  ...
  reviewsPage: {
    ...
    parseError: {
      ...
      detail: 'Charge utile invalide — escaladée en critique jusqu’à examen',
    },
  },
  leaderboardPage: {
    compare: 'Comparer',
  ...
  observabilityPage: {
    ...
    autoFixed: 'Corrigé automatiquement',
    resolved: 'Résolu',
    autoFixApplied: 'Correction automatique appliquée',
    costAnomalyDetected: 'Anomalie de coût détectée le',
    budgetThresholdExceeded: 'Seuil de budget dépassé pour',
    ...
    executionHealth: 'Santé des exécutions',
    latencyDistribution: 'Distribution de latence',
    latencyPercentiles: 'P50 / P95 / P99',
    spendByAgent: 'Dépenses par agent',
    noSpendData: 'Aucune donnée de dépense',
    healthIssues: 'Problèmes de santé',
    open: 'ouverts',
    analyzing: 'Analyse...',
    runAnalysis: 'Lancer l\'analyse',
    runningAnalysis: 'Analyse de santé en cours sur tous les services surveillés...',
    allSystemsHealthy: 'Tous les systèmes sont sains',
    noIssuesDetected: 'Aucun problème détecté sur les services surveillés',
    noSeverityIssues: 'Aucun problème de sévérité {severity}',
    exampleDataNotice: 'Des données d\'exemple sont affichées. Les vraies analyses apparaîtront quand les agents lanceront des exécutions.',
  ...
  eventsPage: {
    ...
    processed: 'Traité',
    retry: 'Réessayer',
    selectForBulkRetry: 'Sélectionner pour réessai groupé',
    showRelatedEvents: 'Afficher {count} événements liés',
    retriedCount: 'Réessayé {count} fois',
    retryEvent: 'Réessayer l\'événement',
    searchPlaceholder: 'Rechercher payloads, types d\'événements, sources, erreurs...',
    ...
    noDeadLettersDescription: 'Les événements échoués avec erreurs apparaîtront ici pour réessai',
    ...
    noEventsDescription: 'Les événements apparaîtront ici lorsque les agents traiteront les déclencheurs et abonnements',
    loadMore: 'Charger plus d\'événements',
    failedEventSelected: 'Événement échoué sélectionné',
    failedEventsSelected: 'Événements échoués sélectionnés',
    selectAllFailed: 'Sélectionner tous les échecs',
  ...
  templatesPage: {
    ...
    gridDescription: 'Les modèles sont des Personas préconfigurés que vous pouvez adopter d’un seul clic. Chaque modèle embarque déjà le prompt, les outils et les déclencheurs pour une tâche précise — sans aucune configuration.',
    ...
    searchPlaceholder: 'Rechercher modèles, outils, services...',
    ...
    filterByComplexity: 'Filtrer par complexité',
    ...
    getStartedTitle: 'Démarrer avec ce modèle',
    getStartedDescription: 'Importez ce modèle directement dans Personas, ou copiez la configuration pour la personnaliser vous-même.',
    openInPersonas: 'Ouvrir dans Personas',
    moreTemplates: 'Plus de modèles {category}',
    appNotFoundTitle: 'Application Personas introuvable',
    appNotFoundDescription: 'Il semble que Personas ne soit pas encore installé sur votre appareil. Téléchargez-le pour importer les modèles directement, ou copiez la configuration pour l\'installer manuellement.',
    templateNotFound: 'Modèle introuvable',
    templateNotFoundDescription: 'Ce modèle n\'existe pas ou a été retiré. Parcourez la galerie pour voir la collection actuelle.',
  ...
  blogPage: {
    eyebrow: 'Blog',
    heading: 'Actualités et',
    headingGradient: 'analyses',
    description: 'Annonces produit, analyses techniques, tutoriels et cas d\'usage concrets par l\'équipe Personas.',
    ...
    of: 'sur',
    posts: 'articles',
    noMatches: 'Aucun article ne correspond à votre recherche',
    ...
    postNotFoundDescription: 'Nous n\'avons pas trouvé l\'article recherché. Il a peut-être été renommé ou déplacé.',
