...
export const fr: Translations = {
  ...
  tour: {
    ...
    step1: 'Voici Personas — votre centre de commande local. Tout ici s’exécute sur votre propre machine, sous votre contrôle.',
    step2: 'Décrivez un objectif en mots simples et regardez l’agent l’analyser, planifier ses étapes et l’exécuter — en direct.',
    step3: 'N’importe lequel des huit types de déclencheurs peut réveiller un agent, et l’orchestrateur répartit le travail entre eux, se réparant lui-même au passage.',
