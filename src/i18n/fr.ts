...
export const fr: Translations = {
    ...
    waitlist: {
      title: "Personas pour {platform}",
      emailPlaceholder: "Entrez votre e-mail",
      earlyBeta: "Je veux un acc\u00e8s b\u00eata anticip\u00e9",
      earlyBetaHint: "Acc\u00e9dez aux versions instables avant la sortie publique",
      joining: "Inscription...",
      success: "Vous \u00eates sur la liste !",
      duplicate: "D\u00e9j\u00e0 inscrit",
      joinCount: "Rejoignez {count} personnes en attente de {platform}",
      spotSaved: "Votre place pour {platform} est enregistr\u00e9e.",
      spotAlreadySaved: "Votre place pour {platform} \u00e9tait d\u00e9j\u00e0 enregistr\u00e9e.",
      betaFlagged: "Vous avez choisi la b\u00eata anticip\u00e9e : votre inscription est marqu\u00e9e pour la premi\u00e8re vague de builds.",
      emailUseOnly: "Votre adresse sert uniquement \u00e0 mesurer la liste d'attente : nous n'envoyons aucun e-mail marketing.",
      announceWhere: "La disponibilit\u00e9 de la b\u00eata est annonc\u00e9e sur la {link} et sur GitHub : suivez l'un ou l'autre.",
      roadmapLink: "feuille de route publique",
      share: "Partager avec un ami",
      manualCopy: "Copie automatique impossible : copiez ce lien",
      invalidEmail: "Veuillez saisir une adresse e-mail valide",
      errorTimeout: "D\u00e9lai de la requ\u00eate d\u00e9pass\u00e9 : veuillez r\u00e9essayer",
      errorRateLimited: "Trop de tentatives : patientez une minute et r\u00e9essayez.",
      errorInvalidPlatform: "Cette plateforme n'est pas encore prise en charge.",
      errorRetryable: "Impossible d'enregistrer votre place pour le moment : r\u00e9essayez dans un instant.",
      copied: "Copi\u00e9 !",
    ...
    guide: {
      ...
      searchAllTopics: "Rechercher dans tous les sujets",
