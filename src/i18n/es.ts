...
export const es: Translations = {
  ...
  roadmapSection: {
    ...
    areas: {
      i18n: { title: 'Internacionalización', caption: '{count} idiomas, traducidos a mano: cada bandera se revela con la cobertura' },
      devices: { title: 'Compatibilidad de dispositivos', caption: 'Personas en cada equipo que tienes' },
      collaboration: { title: 'Colaboración', caption: 'De un solo operador a toda la organización' },
      platform: { title: 'Plataforma principal', caption: 'Modo dev, ejecución en la nube, conectores, instalaciones sencillas' },
      templates: { title: 'Galería de plantillas', caption: 'Agentes iniciales por categoría: recuentos en vivo de la galería' },
    },
    bars: {
      europe: 'Europa',
  ...
  tour: {
    ...
    step3: 'Un agente solo es tan útil como los momentos para los que despierta. Personas se puede activar de diez maneras — por horario, por un evento, sondeando una fuente o desde un webhook entrante. El orquestador dirige cada señal al agente adecuado y mantiene todo en marcha, curándose a sí mismo si un paso falla.',
    ...
    dashboardExecutions: 'Cada ejecución que ha hecho la flota vive aquí, la más reciente primero. La tabla muestra la persona, el estado, la duración, el coste y cuándo empezó — filtra solo los fallos o las que siguen en curso. Haz clic en cualquier fila y se abre la ejecución completa: una franja de métricas, cualquier explicación de error y la salida en vivo transmitida línea a línea, exactamente como la produjo el agente.',
