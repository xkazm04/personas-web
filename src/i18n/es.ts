...
export const es: Translations = {
  ...
  tour: {
    ...
    dashboard1: 'Bienvenido al centro de control. Las insignias en la parte superior son los signos vitales de tu flota de un vistazo — tasa de éxito, ejecuciones en curso, agentes activos, alertas abiertas y revisiones pendientes. Cinco números que te dicen en dos segundos si todo va bien o algo requiere tu atención.',
    dashboard2: 'Justo debajo, el optimizador muestra una mejora de alto impacto a la vez. Ahora apunta a un cambio de enrutamiento que reduciría el coste en parte de las ejecuciones sin tocar la calidad. Aplícalo desde aquí, o descártalo y mañana llegará la siguiente oportunidad.',
    dashboard3: 'Dos paneles de inteligencia viven debajo. A la izquierda, la puntuación de latido de cada agente con los problemas vistos esta semana. A la derecha, nuevas memorias que tus agentes han aprendido y quieren promover — un límite que funcionó, un horario que cuadró mejor. Acepta lo útil, archiva el resto.',
    dashboard4: 'Ahora la imagen en vivo. El feed de actividad a la izquierda muestra cada ejecución según llega, con persona, tiempo y coste. A la derecha, catorce días de tráfico frente a errores — los picos, valles y cambios afloran mucho antes de que se conviertan en incidentes.',
    dashboard5: 'Aleja un nivel más. El mapa de calor muestra ejecuciones por agente, día a día — celdas más densas significan agente más ocupado. De un vistazo ves cuáles agentes hacen el trabajo pesado, cuáles están en reposo y dónde se desplaza la carga durante la semana.',
    dashboard6: 'Y finalmente la fila inferior. La tabla de clasificación lista tus tres mejores agentes con la tendencia que los eleva o hunde. Las rutinas próximas muestran las próximas ejecuciones programadas. Y la bóveda de credenciales registra cada rotación de secretos para que siempre sepas qué claves están frescas. Eso es el centro de control — ejecuciones, salud y operaciones en una sola página.',
