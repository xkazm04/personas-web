...
export const es: Translations = {
  ...
  tour: {
    ...
    step1: 'Esto es Personas — tu centro de mando local. Todo aquí se ejecuta en tu propia máquina, bajo tu control.',
    step2: 'Describe un objetivo con palabras sencillas y observa cómo el agente lo analiza, planifica sus pasos y lo ejecuta — en vivo.',
    step3: 'Cualquiera de los ocho tipos de disparadores puede despertar a un agente, y el orquestador reparte el trabajo entre ellos, curándose a sí mismo sobre la marcha.',
    features1: 'Cada agente empieza como una intención: una frase llena una matriz de persona de ocho dimensiones — tareas, memoria, disparadores y más.',
    features2: 'Aprende mientras trabaja — las lecciones y los patrones se asientan en capas de memoria, así que el agente se afina con cada tarea.',
    features3: 'Cuando un paso falla, el circuito no se detiene: diagnostica el fallo, repara la ruta y reintenta por su cuenta.',
    features4: 'Y lo ves todo — cada ejecución, mensaje y evento fluye en vivo a través de un único panel de observabilidad.',
