...
export const es: Translations = {
    ...
    hero: {
      ...
      description: "Dise\u00f1a agentes en lenguaje natural. Orqu\u00e9stalos en tu propia m\u00e1quina.",
    ...
    observabilityPage: {
      ...
      athenaActionMix: "Coste por tipo de acción",
      athenaOps: {
        chat: "Chat",
        fleetSpawn: "Lanzar flota",
        canvasControl: "Control del lienzo",
        recall: "Recuperación",
        proactiveNudge: "Avisos proactivos",
        execTriage: "Triaje de ejecuciones",
        msgTriage: "Triaje de mensajes",
        reviewResolution: "Resolución de revisiones"
      },
      turnsCount: "{count} turnos",
      athenaSpendLane: "Gasto de Athena",
      spendTurns: "Turnos",
      spendCost: "Coste de Athena",
      spendAvgPerTurn: "Media / turno",
      spendTokens: "Tokens",
      spendTokensDetail: "{in} entrada · {out} salida",
      athenaVsFleet: "Athena vs. flota",
      athenaVsFleetCaption: "{athena} de {total} del gasto total en esta ventana",
    ...
    eventsPage: {
      ...
      columnSelect: "Selecci\u00f3n",
      columnState: "Estado",
      columnPersona: "Persona destino",
      columnRetries: "Reintentos",
    ...
    waitlist: {
      title: "Personas para {platform}",
      emailPlaceholder: "Ingresa tu email",
      earlyBeta: "Quiero acceso anticipado a la beta",
      earlyBetaHint: "Accede a compilaciones inestables antes del lanzamiento p\u00fablico",
      joining: "Uni\u00e9ndose...",
      success: "\u00a1Est\u00e1s en la lista!",
      duplicate: "Ya registrado",
      joinCount: "\u00danete a {count} personas que esperan {platform}",
      spotSaved: "Tu lugar para {platform} est\u00e1 guardado.",
      spotAlreadySaved: "Tu lugar para {platform} ya estaba guardado.",
      betaFlagged: "Te apuntaste a la beta temprana, as\u00ed que tu registro est\u00e1 marcado para la primera oleada de compilaciones.",
      emailUseOnly: "Tu direcci\u00f3n solo se usa para medir la lista de espera; no enviamos correos de marketing.",
      announceWhere: "La disponibilidad de la beta se anuncia en la {link} y en GitHub: sigue cualquiera de los dos.",
      roadmapLink: "hoja de ruta p\u00fablica",
      share: "Comparte con un amigo",
      manualCopy: "No se pudo copiar autom\u00e1ticamente: copia este enlace",
      invalidEmail: "Introduce una direcci\u00f3n de correo v\u00e1lida",
      errorTimeout: "La solicitud ha caducado: int\u00e9ntalo de nuevo",
      errorRateLimited: "Demasiados intentos: espera un minuto e int\u00e9ntalo de nuevo.",
      errorInvalidPlatform: "Esa plataforma a\u00fan no es compatible.",
      errorRetryable: "No se pudo guardar tu lugar ahora mismo: int\u00e9ntalo de nuevo en un momento.",
      copied: "\u00a1Copiado!",
    ...
    roadmapSection: {
      ...
      areas: {
        ...
        platform: {
          ...
          caption: "Modo dev, conectores, instalaciones sencillas"
        },
        templates: {
    ...
    guide: {
      ...
      searchAllTopics: "Buscar en todos los temas",
    searchInCategory: "Buscar en esta categor\u00eda...",
      ...
      categoryDescriptions: {
        ...
        deployment: "Conecta agentes a GitHub Actions, GitLab CI y flujos de n8n.",
