...
export const es: Translations = {
  ...
  reviewsPage: {
    ...
    chapterHome: 'Inicio',
      progress: '{n} de {total}',
      skip: 'Saltar',
      empty: 'Todo al día — sin revisiones pendientes',
      approve: 'Aprobar',
      reject: 'Rechazar',
    },
    parseError: {
      label: 'Error de análisis',
      detail: 'Carga útil malformada — escalada a crítica hasta su revisión',
    },
  },
  leaderboardPage: {
    compare: 'Comparar',
  ...
  observabilityPage: {
    ...
    autoFixed: 'Corregido automáticamente',
    resolved: 'Resuelto',
    autoFixApplied: 'Corrección automática aplicada',
    costAnomalyDetected: 'Anomalía de coste detectada el',
    ...
    runningAnalysis: 'Ejecutando análisis de salud en todos los servicios monitorizados...',
    allSystemsHealthy: 'Todos los sistemas están sanos',
    ...
    exampleDataNotice: 'Se muestran datos de ejemplo. Las analíticas reales aparecerán cuando los agentes empiecen a ejecutar tareas.',
  ...
  eventsPage: {
    ...
    searchPlaceholder: 'Buscar payloads, tipos de evento, orígenes, errores...',
    ...
    noDeadLettersDescription: 'Los eventos fallidos con errores aparecerán aquí para reintento',
    noMatchingEvents: 'No hay eventos coincidentes',
    noEvents: 'No hay eventos',
    noMatchingEventsDescription: 'Prueba a ajustar la búsqueda o los filtros',
    noEventsDescription: 'Los eventos aparecerán aquí cuando los agentes procesen disparadores y suscripciones',
  ...
  templatesPage: {
    ...
    subtitle: 'Explora {count} plantillas de agentes listas para usar, agrupadas por tipo de trabajo. Elige una categoría para ver las plantillas dentro.',
    gridHeading: 'Explorar plantillas por categoría',
    gridDescription: 'Las plantillas son Personas preconfiguradas que puedes adoptar con un solo clic. Cada plantilla ya trae el prompt, las herramientas y los disparadores listos para una tarea concreta — sin necesidad de configurar nada.',
    changeCategory: 'Cambiar categoría',
    complexityAll: 'Todas',
    complexityBasic: 'Básica',
    ...
    getStartedDescription: 'Importa esta plantilla directamente en Personas o copia la configuración para personalizarla tú mismo.',
    openInPersonas: 'Abrir en Personas',
    moreTemplates: 'Más plantillas de {category}',
    appNotFoundTitle: 'Aplicación Personas no encontrada',
    appNotFoundDescription: 'Parece que Personas aún no está instalado en tu dispositivo. Descárgalo para importar plantillas directamente o copia la configuración para configurarla manualmente.',
    templateNotFound: 'Plantilla no encontrada',
    templateNotFoundDescription: 'Esta plantilla no existe o se ha retirado. Explora la galería para ver la colección actual.',
  ...
  blogPage: {
    ...
    description: 'Anuncios de producto, análisis técnicos, tutoriales y casos de uso reales del equipo de Personas.',
    ...
    of: 'de',
    posts: 'publicaciones',
    noMatches: 'Ninguna publicación coincide con tu búsqueda',
    ...
    postNotFoundDescription: 'No encontramos el artículo que buscas. Puede que se haya renombrado o movido.',
