      ...
      <PageShell scrollMapItems={scrollMapItems}>
        ...
        <SectionWrapper id="security" aria-label="Security overview">
          <motion.div variants={fadeUp} className="text-center mb-16">
            <p className="mb-4 text-sm font-medium uppercase tracking-widest text-brand-emerald/70">
              Security & Privacy
            </p>
            <SectionHeading>
              Your data{" "}
        ...
        <SectionWrapper id="compliance" aria-label="Compliance">
          ...
          <motion.div
            variants={fadeUp}
            className="mx-auto max-w-3xl rounded-2xl border border-white/8 bg-black/40 backdrop-blur-xl overflow-hidden"
          >
        ...
        <SectionWrapper id="security-cta" aria-label="Get started">
          <motion.div variants={fadeUp} className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/#download"
                className="inline-flex items-center gap-2 rounded-full bg-brand-emerald/15 border border-brand-emerald/30 px-8 py-3 text-sm font-semibold text-brand-emerald transition-colors hover:bg-brand-emerald/25"
              >
