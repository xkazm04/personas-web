  ...
  return (
    <div className="px-6 pb-24">
      <div className="mx-auto max-w-3xl">
        {/* Breadcrumb */}
        <nav className="mt-8 flex items-center gap-1.5 text-base text-muted-dark">
        ...
        <div className="mt-16 grid grid-cols-2 gap-4">
          {prevTopic ? (
            ...
            >
              <ChevronLeft className="h-4 w-4 shrink-0 text-muted-dark transition-transform group-hover:-translate-x-0.5" />
          ...
          {nextTopic ? (
            ...
            >
              ...
              <ChevronRight className="h-4 w-4 shrink-0 text-muted-dark transition-transform group-hover:translate-x-0.5" />
            </Link>
          ) : (
            <div />
          )}
