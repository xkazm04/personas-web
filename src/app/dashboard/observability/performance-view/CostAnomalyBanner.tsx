...
export function CostAnomalyBanner({ anomalies, label }: { anomalies: CostAnomaly[]; label: string }) {
      ...
      <AnimatePresence mode="popLayout">
        {visible.map((anomaly) => (
          ...
          >
            ...
            <button onClick={() => handleDismiss(anomaly.date)} className="rounded-lg p-1 text-amber-400/70 hover:bg-amber-500/10 hover:text-amber-400 transition-colors cursor-pointer">
