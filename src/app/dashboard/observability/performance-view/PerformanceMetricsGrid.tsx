...
export function PerformanceMetricsGrid({
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4 mb-8">
      <MetricCard icon={DollarSign} label={labels.totalCost} value={`$${(metrics?.totalCost ?? 0).toFixed(2)}`} trend={metrics?.costTrend} trendLabel="vs last period" accent="cyan" sparklineData={SPARKLINE_COST} />
