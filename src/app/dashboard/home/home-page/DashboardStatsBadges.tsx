...
export function DashboardStatsBadges({
  ...
  return (
    <>
      ...
      />
      <StatBadge icon={Zap} label={labels.totalExecutions} value={stats.total} accent="cyan" href="/dashboard/executions" />
      ...
      <StatBadge icon={Mail} label={labels.unreadMessages} value={unreadMessages} accent="rose" href="/dashboard/messages" />
    </>
  );
}
