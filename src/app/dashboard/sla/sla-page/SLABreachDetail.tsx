...
// the full (untruncated) summary, absolute start/resolve timestamps, and a
// duration bar scaled against the longest breach currently in view.
export function SLABreachDetail({
  ...
  maxDuration: number;
  labels: { started: string; resolved: string; ongoing: string };
}) {
  ...
  return (
    <div className="border-t border-glass px-2 pb-3 pt-2.5">
      ...
      <div className="mt-2.5">
        <div className="mb-1 flex justify-end text-sm tabular-nums text-muted-dark">
          {durationLabel}
        </div>
