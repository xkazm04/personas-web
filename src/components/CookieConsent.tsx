...
export default function CookieConsent() {
  ...
  useEffect(() => {
    if (!localStorage.getItem(COOKIE_CONSENT_KEY)) queueMicrotask(() => setVisible(true));
  }, []);
  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="relative w-full max-w-4xl rounded-2xl bg-surface/95 backdrop-blur-xl border border-glass-hover px-6 py-4 shadow-2xl">
            <button
