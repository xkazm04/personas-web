      ...
      <ol className="space-y-5 list-none">
        {steps.map((step, i) => (
          <li key={i} className="relative">
            <span
              className="absolute -left-8 top-0.5 flex h-[26px] w-[26px] items-center justify-center rounded-full border border-white/[0.12] bg-white/[0.05] text-base font-bold text-brand-cyan backdrop-blur-sm"
              aria-hidden="true"
            >
              {i + 1}
            </span>
