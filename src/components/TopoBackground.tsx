...
export default function TopoBackground() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      {/* Layer 1: Large outer contours + detail lines — slowest */}
      <div
        className="absolute -inset-[10%] parallax-shape"
        style={{ "--parallax-offset": "-50px" } as React.CSSProperties}
      >
        <div className="topo-bg h-full w-full opacity-[0.05]">
          <svg {...SVG_PROPS}>
            <path
            ...
            <defs>
              <linearGradient id={grad1} x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor={rgba(BRAND_COLORS.cyan, 0.8)} />
                <stop offset="50%" stopColor={rgba(BRAND_COLORS.purple, 0.4)} />
                <stop offset="100%" stopColor={rgba(BRAND_COLORS.cyan, 0.8)} />
              </linearGradient>
              <linearGradient id={grad2} x1="100%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor={rgba(BRAND_COLORS.purple, 0.8)} />
                <stop offset="50%" stopColor={rgba(BRAND_COLORS.cyan, 0.4)} />
                <stop offset="100%" stopColor={rgba(BRAND_COLORS.purple, 0.8)} />
              </linearGradient>
            </defs>
          </svg>
        </div>
      ...
      {/* Layer 2: Top-left cluster — medium speed */}
      <div
        className="absolute -inset-[10%] parallax-shape"
      ...
      >
        <div className="topo-bg h-full w-full opacity-[0.05]">
          <svg {...SVG_PROPS}>
            <circle cx="250" cy="220" r="90" stroke={rgba(BRAND_COLORS.cyan, 0.8)} strokeWidth="0.8" />
      ...
      {/* Layer 3: Bottom-right + accent clusters — fastest */}
      <div
        className="absolute -inset-[10%] parallax-shape"
      ...
      >
        <div className="topo-bg h-full w-full opacity-[0.05]">
          <svg {...SVG_PROPS}>
            <circle cx="920" cy="580" r="75" stroke={rgba(BRAND_COLORS.purple, 0.7)} strokeWidth="0.8" />
            <circle cx="920" cy="580" r="52" stroke="white" strokeWidth="0.5" />
            <circle cx="920" cy="580" r="30" stroke="white" strokeWidth="0.4" />
            <ellipse cx="850" cy="300" rx="50" ry="70" stroke={rgba(BRAND_COLORS.emerald, 0.6)} strokeWidth="0.6" />
