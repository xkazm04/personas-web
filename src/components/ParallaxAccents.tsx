...
const accents: AccentDef[] = [
  { type: "ring", x: "7%", y: "12%", size: 54, color: "rgba(6,182,212,0.15)", speed: 0.15 },
  { type: "cross", x: "88%", y: "22%", size: 24, color: "rgba(168,85,247,0.18)", speed: 0.3 },
  { type: "diamond", x: "14%", y: "42%", size: 16, color: "rgba(52,211,153,0.15)", speed: 0.2 },
  { type: "dot", x: "93%", y: "52%", size: 14, color: "rgba(251,191,36,0.12)", speed: 0.4 },
  { type: "ring", x: "78%", y: "68%", size: 46, color: "rgba(168,85,247,0.12)", speed: 0.12 },
  { type: "cross", x: "22%", y: "78%", size: 20, color: "rgba(6,182,212,0.15)", speed: 0.35 },
  { type: "diamond", x: "62%", y: "32%", size: 14, color: "rgba(244,63,94,0.1)", speed: 0.25 },
  { type: "dot", x: "42%", y: "88%", size: 12, color: "rgba(96,165,250,0.14)", speed: 0.45 },
];
