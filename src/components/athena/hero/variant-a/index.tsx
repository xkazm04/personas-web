  ...
  return (
    <AthenaStage>
      <section className="relative flex min-h-dvh flex-col">
        {/* The schematic — orb square centered on a wider md+ stage */}
        <div className="relative z-[1] flex flex-1 flex-col items-center justify-center px-4 pt-16 sm:pt-20">
          <motion.div
            ...
            className="relative aspect-square w-full max-w-[min(88vmin,560px)] md:aspect-[880/640] md:max-w-[880px]"
          >
        ...
        <div className="relative z-[2] px-6 pb-12 pt-10 sm:pb-16">
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <motion.h1 {...pop(0.14)} className="mt-4 text-5xl font-bold tracking-tight text-foreground sm:text-7xl">
              {COPY.headline}
            </motion.h1>
            <motion.p {...pop(0.24, 1)} className="mt-4 text-xl text-foreground/80 sm:text-2xl">
              {COPY.tagline}
            </motion.p>
            <motion.p {...pop(0.32, -1)} className="mx-auto mt-3 max-w-lg text-sm leading-relaxed text-muted-dark">
              {COPY.persona}
            </motion.p>
            ...
            <motion.p {...pop(0.52, -1)} className={`mt-6 ${ANNOTATION_DIM} normal-case tracking-wide text-[11px]`}>
              {COPY.statWhisper}
            </motion.p>
          </div>
        </div>
