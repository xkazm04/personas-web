    ...
    <SectionWrapper id="plugins">
      ...
      >
        <SectionIntro
          ...
          gradient="plug in"
          description="Purpose-built plugins shipped with Personas. Each one is a self-contained workspace your agents can drive, reuse shared credentials, and compose together. Switch a tab, meet a new specialist."
          className="mb-0"
        />
      </motion.div>
