...
> = {
  ghost: {
    wrapper:
      "rounded-full p-[2px] bg-gradient-to-r from-brand-cyan via-blue-400 to-brand-purple motion-safe:animate-border-flow shadow-[0_0_30px_color-mix(in_srgb,var(--brand-cyan)_30%,transparent)] hover:shadow-[0_0_50px_color-mix(in_srgb,var(--brand-purple)_50%,transparent)] transition-shadow duration-500",
    inner:
