...
const stats = [
  { value: 11, suffix: "/15", label: "Agentic templates" },
  { value: 228, suffix: "+", label: "Users" },
  { value: 34, suffix: "K", label: "Ran operations" },
  { value: 24, suffix: "", label: "Tools connected" },
  { value: 70, suffix: "+", label: "CLI Commands" },
  { value: 2, suffix: "s", label: "Cold Start", prefix: "<" },
];
