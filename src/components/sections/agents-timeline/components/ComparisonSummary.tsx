    ...
    <AnimatePresence>
      {showResults && (
        <motion.div
          ...
          className="rounded-xl border border-glass-hover bg-white/[0.03] p-4 backdrop-blur-sm"
        >
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-base font-mono uppercase tracking-wider text-brand-rose/80">
                  Workflow
                </span>
              </div>
              ...
              <div className="flex items-center justify-center gap-1 text-base text-brand-rose/80 font-mono mt-1">
                <X className="h-3 w-3" />
                FAILED
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-base font-mono uppercase tracking-wider text-brand-emerald/80">
                  Agent
                </span>
              </div>
              ...
              <div className="flex items-center justify-center gap-1 text-base text-brand-emerald/80 font-mono mt-1">
