        ...
        <AnimatePresence mode="wait">
          ...
          >
            {copy.highlights.map((item) => (
              <span
                key={item}
                className="rounded-full border border-white/10 bg-white/3 px-4 py-2 text-base font-mono tracking-wider text-muted backdrop-blur-sm transition-colors hover:bg-white/8 hover:text-white shadow-[0_0_10px_rgba(255,255,255,0.02)]"
              >
                {item}
              </span>
            ))}
