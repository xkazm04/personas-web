...
export function PipelineProgressBar({
  ...
  return (
    <div className="relative h-1 bg-white/[0.03]" role="progressbar" aria-label="Pipeline progress" aria-valuenow={Math.round(progressPercent)} aria-valuemin={0} aria-valuemax={100}>
