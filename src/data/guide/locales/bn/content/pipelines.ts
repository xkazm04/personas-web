...
Pipeline প্রতিটি ধাপ হাতে তৈরি করে। অ্যাসাইনমেন্ট তা উল্টে দেয়: আপনি টিমকে সহজ ভাষায় একটি **লক্ষ্য** দেন, এবং টিম নিজেই ধাপগুলি বের করে নেয়। সে লক্ষ্যটিকে একটি চেকলিস্টে ভাঙে, প্রতিটি ধাপের জন্য সেরা এজেন্ট বেছে নেয়, এবং সমান্তরালে চালায় — শুধুমাত্র যখন কোনো ধাপ ব্যর্থ হয় বা সিদ্ধান্তের প্রয়োজন তখনই আপনাকে জিজ্ঞেস করে।

এটাকে ফ্লোচার্ট আঁকা আর একজন প্রজেক্ট ম্যানেজারকে ব্রিফ করার মধ্যকার পার্থক্য ভাবুন। Pipeline-এ আপনি প্রবাহ ডিজাইন করেন; অ্যাসাইনমেন্টে আপনি ফলাফল বলেন এবং টিমকে সেটি ঘিরে সংগঠিত হতে দেন।

### মূল পয়েন্ট

- **লক্ষ্য-প্রথম** — আপনি কী চান তা বলুন; টিম তা ক্রমানুযায়ী ধাপে বিভক্ত করে
- **স্মার্ট ম্যাচিং** — প্রতিটি ধাপ সবচেয়ে উপযুক্ত এজেন্টের কাছে রাউট হয় (আপনি ম্যানুয়ালি এজেন্ট নির্ধারণ করতে, দ্রুত স্থানীয় ম্যাচিং ব্যবহার করতে, বা মডেলকে সিদ্ধান্ত নিতে দিতে পারেন)
- **অটো-ডিকম্পোজ** — এক ক্লিকে একটি লক্ষ্যকে সম্পাদনযোগ্য ধাপের তালিকায় পরিণত করে যা চালানোর আগে আপনি পরিবর্তন করতে পারেন
- **সমান্তরাল নির্বাহ** — স্বাধীন ধাপ একই সময়ে চলে; নির্ভরশীল ধাপ তাদের পালার জন্য অপেক্ষা করে
- **ব্যর্থতায় মানবিক পর্যালোচনা** — একটি ব্যর্থ ধাপ শুধু সেই অ্যাসাইনমেন্টটি বিরতি দেয় এবং Edit / Reassign / Skip বিকল্প দেয়, টাইটেল বারে বিজ্ঞপ্তিসহ
- **পুনর্ব্যবহারযোগ্য টেমপ্লেট** — একটি লক্ষ্য + ধাপের বিন্যাস টেমপ্লেট হিসেবে সংরক্ষণ করুন এবং তা থেকে নতুন অ্যাসাইনমেন্ট তৈরি করুন
- **চ্যাট ডিসপ্যাচ** — Athena-কে বলুন "গবেষণা টিমকে এটি সামলাতে বলো" এবং সে আপনার অনুমোদনের জন্য সেটি সেট আপ করবে

### এটি কীভাবে কাজ করে

একটি টিমের canvas খুলুন এবং **Assignments** ব্যাজে ক্লিক করুন (নিচে-বাঁয়ে)। **New** চাপুন, একটি লক্ষ্য টাইপ করুন, এবং হয় নিজে ধাপগুলি পূরণ করুন অথবা **Auto-decompose** ক্লিক করুন যাতে সহকারী সেগুলি প্রস্তাব করে। ধাপে এজেন্ট কীভাবে মেলানো হবে তা বেছে নিন, একসাথে কতটি চলবে তা সেট করুন, এবং **Create & start** ক্লিক করুন। চেকলিস্ট লাইভ আপডেট হতে দেখুন; কোনো ধাপ ব্যর্থ হলে সেটি সরাসরি সমাধান করুন। যা আবার চালাবেন তা টেমপ্লেট হিসেবে সংরক্ষণ করুন।

:::tip
যখন আপনি ফলাফল জানেন কিন্তু সঠিক ধাপ জানেন না তখন অ্যাসাইনমেন্ট ব্যবহার করুন। যখন প্রতিটি সংযোগের উপর নিখুঁত, পুনরাবৃত্তিযোগ্য নিয়ন্ত্রণ চান তখন pipeline ব্যবহার করুন। টেমপ্লেট দুটির মেলবন্ধন ঘটায় — একটি সংরক্ষিত অ্যাসাইনমেন্ট এক ক্লিকের শুরুর বিন্দু হয়ে যায়।
:::
  `,
...
একটি টিম কেবল কিছু এজেন্টের সমষ্টি নয় — এটি এমন এজেন্ট যারা **একসাথে মনে রাখে** এবং একটি ভাগ করা ফলাফলের দিকে এগিয়ে যায়। দুটি জিনিস এটিকে কার্যকর করে: ভাগ করা টিম মেমরি, এবং লক্ষ্য।

### ভাগ করা টিম মেমরি

একটি টিম কাজ করার সাথে সাথে সে সিদ্ধান্ত এবং সীমাবদ্ধতা রেকর্ড করে — "আমরা এই ফরম্যাটে মানসম্পন্ন করেছি", "এই অ্যাকাউন্ট আওতার বাইরে", "পর্যালোচক পদ্ধতি X প্রত্যাখ্যান করেছেন"। সেই নোটগুলি **টিম মেমরি** হয়ে ওঠে, এবং সবচেয়ে গুরুত্বপূর্ণগুলির একটি সংক্ষিপ্ত সারাংশ পরবর্তী রানে প্রতিটি সদস্যের প্রসঙ্গে প্রবাহিত হয়।

প্রভাব: টিম নিজেকে পুনরাবৃত্তি করার বদলে এগিয়ে যায়। একটি এজেন্টকে সতীর্থের ইতিমধ্যে নেওয়া সিদ্ধান্ত পুনরায় আবিষ্কার করতে হয় না — সে তা উত্তরাধিকারসূত্রে পায়। canvas-এর Team Memory প্যানেলে আপনি এই মেমরি দেখতে ও পরিচর্যা করতে পারেন।

### লক্ষ্য — মাইক্রোম্যানেজ না করে দিক নির্দেশ করুন

একটি টিমকে একটি **লক্ষ্যের** সাথে যুক্ত করুন এবং আপনি পৃথক রান পর্যবেক্ষণ করা থেকে মুক্তি পাবেন। লক্ষ্য টিম কাজ করার সাথে সাথে অগ্রগতি ট্র্যাক করে, এবং অ্যাপ শুধুমাত্র যা সত্যিই একজন মানুষের প্রয়োজন তা তুলে ধরে — একটি থামানো লক্ষ্য, আসন্ন সময়সীমা, আপনার পর্যালোচনার অপেক্ষায় একটি ধাপ। বাকি সবকিছু চলতে থাকে।

এটি হল "দিকনির্দেশ সেট করুন, উঁচু স্তরে থাকুন" চক্র: আপনি ফলাফল ও সীমানা নির্ধারণ করেন; টিম বাকিটা সামলায় এবং প্রয়োজনে হাত তোলে।

:::tip
টিম মেমরিকে টিমের প্রাতিষ্ঠানিক জ্ঞান এবং লক্ষ্যকে তার উত্তর তারা হিসেবে ভাবুন। মেমরি টিমকে রান থেকে রানে সামঞ্জস্যপূর্ণ রাখে; লক্ষ্য তাকে মূল্যবান কিছুর দিকে নির্দেশিত রাখে।
:::

### মূল পয়েন্ট

- **ভাগ করা মেমরি** — টিমের রেকর্ড করা সিদ্ধান্ত/সীমাবদ্ধতা পরবর্তী রানে প্রতিটি সদস্যের প্রসঙ্গে ইনজেক্ট হয়
- **অভিসারণ** — সদস্যরা একে অপরের উপসংহারের উপর ভিত্তি করে গড়ে তোলে, সেগুলি পুনরায় আঁকার বদলে
- **লক্ষ্য সংযোগ** — অগ্রগতি ও সময়সীমা ট্র্যাক করতে একটি টিমকে লক্ষ্যের সাথে বাঁধুন
- **প্রকাশিত, চাপা নয়** — মনোযোগ সারি শুধুমাত্র যা আপনার দরকার তা তোলে (থামানো, মেয়াদোত্তীর্ণ, পর্যালোচনার অপেক্ষায়)
- **পরিচর্যা করুন** — canvas প্যানেল থেকে টিম মেমরি পর্যালোচনা, সম্পাদনা বা সরান
  `,
